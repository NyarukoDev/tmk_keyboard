...
#define KEYMAP( \
    ...
    K2A, K2B, K2C, K2D, K2E, K2F, K2G, K2H, K2I, K2J, K2K, K2L, K2N, K2M,                    K2O, K2P, K2Q, \
...
/* 03 */ { KC_##K1R,    KC_##K2A, KC_##K5B, KC_##K4C, KC_##K3C, KC_##K2C, KC_##K1C, KC_NO    }, \
...
/* 0A */ { KC_##K2L, KC_##K3L, KC_##K4L, KC_##K4K, KC_##K3K, KC_##K2K, KC_##K2N, KC_##K1K }, \
/* 0B */ { KC_NO,    KC_##K2O, KC_##K3O, KC_##K5L, KC_##K3R, KC_##K1N, KC_##K4R, KC_##K0G }, \
/* 0C */ { KC_##K0I, KC_##K2P, KC_##K4O, KC_##K5M, KC_##K3S, KC_##K1O, KC_##K4S, KC_##K0H }, \
/* 0D */ { KC_##K0J, KC_##K2Q, KC_##K4Q, KC_##K3Q, KC_##K3T, KC_##K1P, KC_##K4T, KC_##K4U }, \
...
static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    KEYMAP(
        ...
        GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS, EQL, BSPC,     INS,  HOME, PGUP,    NUMLOCK,PSLS,PAST,PMNS,
        TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC, RBRC,BSLS,     DEL, END, PGDN,      P7,  P8,  P9, PPLS,
        CAPSLOCK,A,S,  D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,NUHS,  ENT,                          P4,  P5,  P6,
        LSFT,NUBS,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,      RSFT,          UP,             P1,  P2,  P3, PENT,
        LCTL,LALT,                  SPC,                           RGUI, RCTL,     LEFT,DOWN,RGHT,       P0,       PDOT
    )
};
